...
const MemberCard = () => {
    ...
    const getMemberCard = async (collection) => {
        let histories = []
    ...
    return (
        <div className={styles.div}>
            <div className="h3 h3_sm mt_65 text_center">Mint MemberCard</div>
            <div className={styles.history}>
                ...
                {histories?.map((history, index) => (
                    <MemberCardRow obj={history} key={index} />
                ))}
