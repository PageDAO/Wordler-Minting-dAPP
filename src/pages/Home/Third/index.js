...
const roadmapQ1 = {
    ...
    contents: [
        ...
        {
            img: 'map_plan.png',
            text: 'NFT-Mediated Co-Author Licenses'
        }
    ]
}
...
const faqs = [
    ...
    { "title": "What's the policy on hate speech and copyright infringement?", "content": "Cryptoversal Books and PageDAO maintain a zero-tolerance policy on hate speech and copyright infringement. We reserve the right to remove content that we deem to be in violation of our terms of service, in our sole discretion, and to block access to repeat offenders. Contact an @admin on the PageDAO discord to report any work you believe to be in violation of our community standards. <a href='Https://bit.ly/pagedao-discord' target='_blank'>Https://bit.ly/pagedao-discord</a>" },
